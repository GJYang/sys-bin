...
Currently available applets include:
	...
	[, [[, addgroup, adduser, arp, arping, awk, base64, basename,
	blockdev, bunzip2, bzcat, bzip2, cal, cat, catv, chgrp, chmod,
	chown, chpasswd, chroot, chvt, cksum, clear, comm, cp, cpio, cut,
	date, dd, deallocvt, delgroup, deluser, devmem, df, diff, dirname,
	dmesg, dnsdomainname, dos2unix, du, echo, egrep, env, expand, expr,
	false, fatattr, fgrep, find, fold, free, freeramdisk, fstrim, fsync,
	ftpd, ftpget, ftpput, fuser, getopt, getty, grep, groups, gunzip,
	gzip, hd, hdparm, head, hexdump, hostid, hostname, hwclock, id,
	ifconfig, ifdown, ifplugd, ifup, inetd, insmod, install, iostat, ip,
	ipaddr, ipcalc, ipcrm, ipcs, iplink, iproute, iprule, iptunnel,
	klogd, ln, logger, login, logname, logread, ls, lsmod, lsof, lspci,
	lsusb, lzcat, lzma, lzop, lzopcat, md5sum, mkdir, mkfifo, mknod,
	mkswap, mktemp, modinfo, modprobe, more, mount, mountpoint, mpstat,
	mv, netstat, nice, nmeter, nohup, nslookup, od, openvt, passwd,
	pgrep, ping, ping6, pivot_root, pkill, pmap, printenv, printf,
	pscan, pstree, pwd, rdate, readlink, realpath, reset, rm, rmdir,
	rmmod, route, rpm, rpm2cpio, runlevel, sed, seq, setsid, sha1sum,
	sha256sum, sha3sum, sha512sum, shuf, sleep, sort, split, stat,
	strings, stty, su, sum, sync, sysctl, syslogd, tac, tail, tar,
	tcpsvd, tee, telnet, telnetd, test, time, top, touch, tr,
	traceroute, traceroute6, true, tty, umount, uname, unexpand, uniq,
	unix2dos, unlink, unlzma, unlzop, unxz, unzip, uptime, users,
	usleep, uudecode, uuencode, vi, wall, watch, wc, which, who, whoami,
