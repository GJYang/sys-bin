...
/* #undef HAVE_SECURITY_PAM_FILTER_H */
...
#define PACKAGE_STRING "pure-ftpd 1.0.29"
...
/* #undef PER_USER_LIMITS */

/* probe for /dev/Xrandom at run-time */
/* #undef PROBE_RANDOM_AT_RUNTIME */
...
/* #undef REALPATH_WORKS_WITH_UNREADABLE_DIRECTORIES */

/* Define as the return type of signal handlers (`int' or `void'). */
#define RETSIGTYPE void

/* Define is getgroups(0, NULL) works on your system */
/* #undef SAFE_GETGROUPS_0 */
...
/* Define if you already have standard MD5 functions */
/* #undef USE_SYSTEM_CRYPT_MD5 */
...
/* with uploadscript */
/* #undef WITH_UPLOAD_SCRIPT */

/* with virtual chroot */
/* #undef WITH_VIRTUAL_CHROOT */

/* with virtualhosts */
/* #undef WITH_VIRTUAL_HOSTS */
